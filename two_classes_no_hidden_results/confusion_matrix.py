...
normalized_supplementary_matrix = np.genfromtxt('normalized_supplementary_confusion_matrix_2_classes')
supplementary_matrix = np.genfromtxt('supplementary_confusion_matrix_2_classes')
